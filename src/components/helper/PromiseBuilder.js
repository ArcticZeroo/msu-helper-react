...
var PromiseBuilder = /** @class */ (function (_super) {
    ...
    PromiseBuilder.prototype._waitForPromise = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.props.promise];
                    case 1:
                        data = _a.sent();
                        this.updateSnapshot(ConnectionState_1.default.DONE, data);
                        return [3 /*break*/, 3];
                    case 2:
                        e_1 = _a.sent();
                        this.updateSnapshot(ConnectionState_1.default.DONE, null, e_1);
                        return [3 /*break*/, 3];
    ...
    PromiseBuilder.prototype._handleBuildingLifecycle = function () {
    ...
    PromiseBuilder.prototype.componentDidUpdate = function (prevProps) {
